...
export const apcKey25: Device = {
  ...
  dials: {
    "0:48": { label: "Dial 1", range: [0, 127] },
    "0:49": { label: "Dial 2", range: [0, 127] },
    "0:50": { label: "Dial 3", range: [0, 127] },
    "0:51": { label: "Dial 4", range: [0, 127] },
    "0:52": { label: "Dial 5", range: [0, 127] },
    "0:53": { label: "Dial 6", range: [0, 127] },
    "0:54": { label: "Dial 7", range: [0, 127] },
    "0:55": { label: "Dial 8", range: [0, 127] },
  },
};
